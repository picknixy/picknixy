...
export const reviews: any[] = [
  {
    ...
    content: `
      ...
      <img src="/vitamotion-review.webp" alt="VitaMotion Review 2026 - Rick Kaselj's Mobility System" class="w-full rounded-lg shadow-md my-8" loading="lazy" />
  ...
  },
  {
    ...
    content: `
        ...
        <img src="/quantum-wave-logo.webp" alt="Quantum Wave Official Logo - Brainwave Entrainment Audio Program for Manifestation and Relaxation" class="w-full rounded-lg shadow-md my-8" />
