  ...
  },
  {
    ...
    content: `
      ...
      <div class="prose lg:prose-xl max-w-none text-gray-800">
        ...
        <p class="mb-4">
          Without a working refrigerator, most modern families will lose hundreds of dollars worth of food within 48 hours. Dark Reset teaches ancient, proven preservation techniques—such as smoking, curing, and strategic root cellaring—that require zero electricity. It also guides you on how to build a stealthy, high-calorie food stockpile that won't attract unwanted attention. (For those looking to grow their own food in limited space, the <a href="/4-foot-farm-review" class="text-blue-600 hover:underline">4 Foot Farm Blueprint</a> pairs exceptionally well with this section).
        </p>
        ...
        <p class="mb-4">
          In reviewing dozens of survival and preparedness manuals, we frequently encounter products that are overly complex, wildly expensive, or completely out of touch with reality. <strong>Dark Reset</strong> is a refreshing exception. It focuses on the fundamental pillars of survival—water, calories, security, and mindset—in a way that is accessible to the average person.
        </p>
        <p class="mb-4">
