...
export function Category() {
  ...
  const currentReviews = categoryReviews.slice(
    indexOfFirstReview,
    indexOfLastReview,
  );
    ...
    <>
      ...
      <div className="bg-[#f5f5f7] text-[#1d1d1f] py-16 border-b border-[#d2d2d7]">
        <div className="max-w-5xl mx-auto px-4">
          {parentCategory && (
            <div className="mb-4">
              <Link
                ...
                className="text-[#2997ff] hover:underline text-sm font-medium flex items-center gap-1"
              >
          ...
          <p className="text-xl text-[#6e6e73] max-w-2xl mb-8">
            {category.description}
          </p>

          {category.subcategories && category.subcategories.length > 0 && (
            <div>
              <h3 className="text-sm font-semibold text-[#1d1d1f] uppercase tracking-wider mb-3">
                Subcategories
              </h3>
            ...
            {categoryReviews.length > 0 ? (
              <div className="space-y-8">
                {currentReviews.map((review) => (
                  <div
                    key={review.id}
                    className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden flex flex-col sm:flex-row hover:shadow-md transition-shadow"
                  >
