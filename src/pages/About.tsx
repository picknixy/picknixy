...
export function About() {
  return (
    <>
      <SEO 
        title="About Us" 
        description="Learn about Trusted Reviews Pro, our mission, and our team of expert reviewers."
      />
      
      <div className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight mb-4">About Trusted Reviews Pro</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="prose prose-lg prose-blue max-w-none mb-16">
          <h2>Who We Are</h2>
          <p>Founded in 2024, Trusted Reviews Pro was built out of frustration with the current state of online reviews. Too many sites prioritize quick affiliate commissions over genuine testing and honest feedback.</p>
          ...
          <p>Trusted Reviews Pro is reader-supported. When you buy through links on our site, we may earn an affiliate commission. However, this does not impact our reviews or comparisons. We only recommend products we genuinely believe are the best in their category. If a product is bad, we will tell you.</p>
        </div>

        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Meet Our Experts</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {Object.values(authors).map(author => (
            <div key={author.id} className="bg-white border border-gray-200 rounded-2xl p-6 text-center shadow-sm">
              ...
              <p className="text-sm text-blue-600 font-medium mb-3">{author.role}</p>
